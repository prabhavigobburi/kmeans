...
CLUSTER_INFO = {
    ...
    1: {
        ...
        "characteristics": [
            ...
            "Income: Moderate (30-70k)",
            "Spending Score: Moderate to High (50-100)",
        ],
    },
    2: {
        ...
        "characteristics": [
            "Age: Young (20-50)",
            "Income: Low (20-50k)",
            "Spending Score: Low to Moderate (20-60)",
        ],
    },
    3: {
        ...
        with viz_col2:
            ...
            fig_pie = go.Figure(
                data=[
                    go.Pie(
                        labels=[
                            f"Cluster {i}: {CLUSTER_INFO[i]['name']}"
            ...
            fig_pie.update_layout(
                title="Customer Distribution by Cluster", height=500, showlegend=True
            )
